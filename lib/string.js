...
var Comment, Container, Element, Fragment, Node, StringNodeFactory, Text, bindable, ent, _ref, _ref1,
...
Element = (function(_super) {
  ...
  */
  ...
  Element.prototype._setStyleAttribute = function() {
    var buffer, hasStyles, key;

    buffer = [];
    hasStyles = false;
    for (key in this.style) {
      hasStyles = true;
      if ((this.style[key] == null) || this.style[key] === "") {
        continue;
      }
      buffer.push("" + key + ": " + this.style[key]);
    }
    if (!hasStyles) {
      return;
    }
    return this.setAttribute("style", buffer.length ? buffer.join("; ") + ";" : "");
  };
  ...
  */
  ...
  Element.prototype._parseStyle = function(styles) {
    var newStyles, sp, style, _i, _len, _ref;
