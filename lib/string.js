...
structr(Node, Container, {
  ...
  removeChild: function (child) {
    ...
    if (child.previousSibling) child.nextSibling = child.nextSibling;
    if (child.nextSibling) child.previousSibling = child.previousSibling;
    child.parentNode = child.nextSubling = child.previousSibling = undefined;
  },
